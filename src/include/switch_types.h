...
#define SWITCH_IGNORE_RTP_DURING_DTMF_MAX_TIMEOUT_MS 10000
...
typedef enum {
	...
	SWITCH_ABC_TYPE_DESTROY_USER_DATA
} switch_abc_type_t;
...
typedef enum {
	...
	SWITCH_RTP_FLAG_EXT_AUDIO_LEVEL,
...
typedef enum {
	...
	SWITCH_CODEC_FLAG_RESET_PENDING = (1 << 9),
...
typedef enum {
	...
	SMBF_CONTINUE_ON_HOLD = (int)(1u << 31)
...
typedef enum {
	...
	SWITCH_EVENT_GENERAL,
	SWITCH_EVENT_COMMAND,
	SWITCH_EVENT_COMMAND_INTERRUPTED,
	SWITCH_EVENT_SESSION_HEARTBEAT,
	SWITCH_EVENT_CLIENT_DISCONNECTED,
	SWITCH_EVENT_SERVER_DISCONNECTED,
	SWITCH_EVENT_SEND_INFO,
